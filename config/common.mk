...
# Set all versions
ZROM_VERSION := ZROM-$(PRODUCT_VERSION_MAJOR)-$(ZROM_BUILD_TYPE)-$(shell date +%Y-%m-%d-%H%M%S)
ZROM_MOD_VERSION := ZROM-$(ZROM_BUILD)-$(PRODUCT_VERSION_MAJOR)-$(ZROM_BUILD_TYPE)-$(shell date +%Y-%m-%d-%H%M%S)
