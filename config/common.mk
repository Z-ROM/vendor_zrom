...
# Set all versions
ZROM_VERSION := ZROM-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(ZROM_BUILD_TYPE)$(ZROM_POSTFIX)
ZROM_MOD_VERSION := ZROM-$(ZROM_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(ZROM_BUILD_TYPE)$(ZROM_POSTFIX)
